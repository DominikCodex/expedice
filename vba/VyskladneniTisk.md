...
Při dočasném výpadku databáze s nastavením fotografií server použije poslední úspěšně načtený seznam z paměti. Pokud jej po startu ještě nemá, načtení nastavení zopakuje po 1, 2 a 4 sekundách. Když zdroj fotografií přesto nelze načíst, vrátí HTTP 503 se srozumitelnou zprávou; nevytvoří úspěšnou sestavu s prázdným seznamem fotek. Makro není potřeba měnit, stačí generování později zopakovat. Jednotlivé nenalezené fotografie ani záměrně nenastavený feed tisk neblokují. Starší HTML již vygenerované bez odkazů na fotky je nutné vytvořit znovu z Excelu; tlačítko `Načíst znovu` používá data uložená v daném HTML.
